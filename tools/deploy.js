...
var items = [ 'index.html', '//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js', 'https://www.dropbox.com/static/api/2/dropins.js' ]
...
exec('s3cmd sync --exclude ".git/*" --exclude ".gitignore" --exclude "tools/*" --exclude-from ".gitignore" --include "webnes.appcache" --delete-removed . s3://htv04.github.io/webnes-ce/', function (error, stdout, stderr) {
	console.log(stdout);
});
